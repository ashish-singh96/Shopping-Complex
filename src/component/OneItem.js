...
const OneItem = () => {
  ...
  return (
   ...
   <div className="flex items-center ml-11 justify-start min-h-screen">
  <div className="flex font-sans shadow-2xl  w-1/2">
    <div className="flex-none w-48 relative">
      <img
        src="../Images/-473Wx593H-466830289-charcoal-MODEL.avif"
        alt="image"
